...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("Kxsanchez323@gmail.com");
    setHasCopied(true);
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I love solving problems and creating things through code. Coding
                is my lifestyle and something that i wish to do forever.
              </p>
            </div>
          </div>
        </div>
